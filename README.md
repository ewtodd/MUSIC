...
<!---->
```sh
nix develop .#87Rb      # or .#37Cl  (default shell is 87Rb)
...
plots, beam calibration/normalization. The TOML control files in
`analysis/<dataset>/control/` (gas fill, beam species/energy, target, detector
response) are used to generate simulated data for the relevant reaction using [Remix-MUSIC-Sim](https://github.com/ewtodd/Remix-MUSIC-Sim). <!---->
## Git hooks
<!---->
