...
void InitDatasetConfig() {
  ...
  gInstance.COMPLETE_CHECK_STRIP_0 = kTRUE;
  ...
  gInstance.STRIP_SUM_SCATTER_CONFIG.X_DISPLAY_MIN = 12;
  gInstance.STRIP_SUM_SCATTER_CONFIG.X_DISPLAY_MAX = 20;
  gInstance.STRIP_SUM_SCATTER_CONFIG.X_STRIP_HI = 16;
  gInstance.STRIP_SUM_SCATTER_CONFIG.Y_DISPLAY_MIN = 4;
  gInstance.STRIP_SUM_SCATTER_CONFIG.Y_DISPLAY_MAX = 14;
  ...
  gInstance.STRIP_SUM_SCATTER_CONFIG.SCATTER_CALC_FROM_SAVGOL = kFALSE;
